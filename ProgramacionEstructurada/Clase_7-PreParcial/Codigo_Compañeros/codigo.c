...
int contador=100 ,cat=0,SueldoAnalistaSenior=0,SueldoAnalistaJunior=0,SueldoProgramador=0,SueldoOperador=0,Depto=0,i=0,SueldoMayor=0,SueldoX=0,SueldoTotal=0;
...
system("color 02");
printf("el total de suerdos a pagar por departamento 1 es de: %d\n",AcumuladorSdepto1);
printf("el total de suerdos a pagar por departamento 2 es de: %d\n",AcumuladorSdepto2);
printf("el total de suerdos a pagar por departamento 3 es de: %d\n",AcumuladorSdepto3);
...
printf("en el depto nro1 trabjan %d empleados\n",CantEmpleadosDepto1);
printf("en el depto nro2 trabjan %d empleados\n",CantEmpleadosDepto2);
printf("en el depto nro3 trabjan %d empleados\n",CantEmpleadosDepto3);
