...
/* 4. Ingresar nombres y notas de alumnos teniendo en cuenta que la carga finaliza con nota = 11, calcular e imprimir el promedio, los aprobados y cuántos estan entre 4 y 6.. */
